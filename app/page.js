...
export default function Home() {
  return (
    <>
      <Header />
      <div
        className="relative pt-16 pb-32 flex content-center items-center justify-center top-[-100px]"
        style={{
          minHeight: "75vh",
        }}
      >
            ...
            <div className="w-full lg:w-6/12 px-4 ml-auto mr-auto text-center">
              <div className="pr-12">
                ...
                <p className="mt-4 text-lg text-gray-300">
                  A technology-first publisher specializing in entertainment,
                  looking to partner with affiliates to drive traffic to our
                  websites
                </p>
              </div>
            </div>
            ...
            <div className="lg:pt-12 pt-6 w-full md:w-4/12 px-4 text-center">
              <div className="relative flex flex-col min-w-0 break-words bg-gray-800 w-full mb-8 shadow-lg rounded-lg">
                <div className="px-4 py-5 flex-auto">
                  ...
                  <Image
                    className="p-3 inline-flex items-center justify-center mb-5"
                    src={commingsoon}
                    width={180}
                    alt="Comming_Soon"
                  />
          ...
          <div className="flex flex-wrap items-center mt-32">
            <div className="w-full md:w-5/12 px-4 mr-auto ml-auto">
              ...
              <p className="text-base font-light leading-relaxed mt-4 mb-4 text-gray-300">
                1. You have the freedom to select stories based on your fanbase,
                and the choice to decide if you want to pursue them. Your
                storytelling, your decision.
              </p>
              <p className="text-base font-light leading-relaxed mt-0 mb-4 text-gray-300">
                2. Plus, if your fans share the story, you will earn from every
                click their friends give as well! More shares, more earnings for
                you.
              </p>
              <p className="text-base font-light leading-relaxed mt-0 mb-4 text-gray-300">
                3. With our excellent tracking system, you can always see in
                real time where your clicks are coming from and how much money
                you are earning. Stay informed and in control of your earnings
                effortlessly.
              </p>
              <p className="text-base font-light leading-relaxed mt-0 mb-4 text-gray-300">
                4. Every click from your fans on the story means compensation
                and rewards for you, whether it is on Facebook, Instagram,
                Twitter, or any other platform! Your fans engagement pays off
                across all channels
              </p>
              <a
                href="mailto:princetechus46@gmail.com"
              ...
              <div className="relative flex flex-col min-w-0 break-words  w-full mb-6 shadow-lg rounded-lg bg-blue-600">
                ...
                <blockquote className="relative p-8 mb-4">
                  ...
                  <p className="text-md font-light mt-2 text-white">
                    Make money by sharing stories your followers love. Turn your
                    unique voice into income. Every captivating tale you share
                    opens up a new way to earn, building a community that can
                    not wait for your next story.
                  </p>
                </blockquote>
              </div>
            </div>
            ...
            <div className="w-full md:w-5/12 ml-auto mr-auto px-4">
              <div className="md:pr-12">
                ...
                <p className="mt-4 text-lg leading-relaxed text-gray-300">
                  We generate the industrys highest conversion rates and drive
                  over 1.5B readers yearly. <strong>Prince Tech</strong>{" "}
                  affiliate team is looking for partners that want to launch a
          ...
          <div className="flex flex-wrap justify-center text-center mb-24">
            <div className="w-full lg:w-6/12 px-4">
              ...
              <p className="text-lg leading-relaxed m-4 text-gray-300">
                <span className="font-bold text-2xl text-gray-500">T</span>
                ogether{" "}
                <span className="font-bold text-2xl text-gray-500">E</span>
                veryone{" "}
                <span className="font-bold text-2xl text-gray-500">A</span>
                chieves{" "}
                <span className="font-bold text-2xl text-gray-500">M</span>ore!
              </p>
            </div>
          </div>
          <div className="flex flex-wrap">
              ...
              <div className="px-6">
                ...
                <div className="pt-6 text-center">
                  ...
                  <div className="mt-3 flex items-center justify-center gap-1">
                    ...
                    <Link
                      href={"https://www.instagram.com/nawab_webdev/"}
                      target="blank"
                      className="w-11 h-11"
                    >
                      <lord-icon
            ...
            <div className="w-full md:w-6/12 lg:w-3/12 lg:mb-0 mb-12 px-4">
              <div className="px-6">
                ...
                <div className="pt-6 text-center">
                  ...
                  <div className="mt-3 flex items-center justify-center gap-1">
                    <Link href={"#"} target="blank" className="w-11 h-11">
                      <lord-icon
            ...
            <div className="w-full md:w-6/12 lg:w-3/12 lg:mb-0 mb-12 px-4">
              <div className="px-6">
                ...
                />
                <div className="pt-6 text-center">
                  <h5 className="text-white text-xl font-bold">Aftab Ahmad</h5>
                  <p className="mt-1 text-sm text-gray-400 uppercase font-semibold">
                    Co-Founder
                  </p>
                  <div className="mt-3 flex items-center justify-center gap-1">
                    <Link
                      href={"https://www.facebook.com/brogrammer77/"}
                      target="blank"
                      className="w-11 h-11"
                    >
                      <lord-icon
                    ...
                    <Link
                      href={"https://www.instagram.com/iffi.8/"}
                      target="blank"
                      className="w-11 h-11"
                    >
                      <lord-icon
            ...
            <div className="w-full md:w-6/12 lg:w-3/12 lg:mb-0 mb-12 px-4">
              <div className="px-6">
                ...
                <div className="pt-6 text-center">
                  ...
                  <div className="mt-3 flex items-center justify-center gap-1">
                    <Link
                      href={"https://www.facebook.com/shahzad.haroon.589"}
                      target="blank"
                      className="w-11 h-11"
                    >
                      <lord-icon
                    ...
                    <Link
                      href={"https://www.instagram.com/shahzadharoon143"}
                      target="blank"
                      className="w-11 h-11"
                    >
                      <lord-icon
          ...
          <div className="flex flex-wrap text-center justify-center">
            <div className="w-full lg:w-6/12 px-4">
              ...
              <p className="text-lg leading-relaxed mt-4 mb-4 text-gray-400">
                We provide a platform for you to share your stories with your
                followers. When your fans click on and engage with your stories,
                you earn compensation for each click. Find answers to commonly
                asked questions about our platform and how it works. Whether you
                are curious about payment methods, story selection, or tracking
                your earnings, we have got you covered with these FAQs.
              </p>
            </div>
          </div>
          <div className="flex flex-wrap mt-12 justify-center">
            <div className="w-full lg:w-3/12 px-4 text-center">
              ...
              <p className="mt-2 mb-4 text-gray-400">
                To track your earnings, simply log into your account and access
                our user-friendly dashboard. Here, you will find detailed
                insights into where your clicks are coming from and the
                corresponding earnings. Our system provides real-time updates,
                ensuring you are always in the know about your earnings.
              </p>
            </div>
            <div className="w-full lg:w-3/12 px-4 text-center">
              <div className="text-gray-900 p-3 w-12 h-12 shadow-lg rounded-full bg-gray-800 inline-flex items-center justify-center">
              ...
              <p className="mt-2 mb-4 text-gray-400">
                We offer various payment methods to ensure convenience for our
                users. You can choose from options such as Bank Transfers,
                PayPal, Payoneer, or other electronic payment methods. When you
                reach the minimum threshold for payout, simply select your
                preferred payment method in your account settings, and we will
                process your earnings accordingly.
              </p>
            </div>
            <div className="w-full lg:w-3/12 px-4 text-center">
              <div className="text-gray-900 p-3 w-12 h-12 shadow-lg rounded-full bg-gray-800 inline-flex items-center justify-center">
              ...
              <p className="mt-2 mb-4 text-gray-400">
                The RPM (Revenue per Mille) for visitors on our platform ranges
                from a minimum of $2 to as high as $18. This range is based on
                the traffic arrangement and engagement levels. We aim to provide
                a minimum RPM of $2 to ensure a consistent earning potential,
                while higher RPMs up to $18 can be achieved with optimized
